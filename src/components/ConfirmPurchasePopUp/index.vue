    ...
    <view class="popup" v-show="visible" @click.stop="handleMaskClick">
        ...
        <view class="popup-content" @click.stop>
            ...
            <view class="content-area">
                ...
                <view class="product-info">
                    ...
                    <view class="product-price">
                        ...
                        <text class="price-original" v-if="originalPrice > price">¥{{originalPrice}}</text>
                    </view>
            ...
            <view class="button-area">
                <button class="pay-button" @tap="handlePayment" :loading="isLoading">立即支付 {{price}}元</button>
...
export default {
    ...
    methods: {
        ...
        handlePayment() {
            ...
            // 调用云函数创建支付订单
            this.createPayOrder().then(orderInfo => {
                uni.hideLoading();
